...
```bash
git clone https://github.com/YoHa2024NKU/Tigrinya_TrOCR_Printed.git
cd Tigrinya_TrOCR_Printed
...
```
python app.py
Launches a Flask web application for interactive Tigrinya OCR. Launch the local web app to test images. Features **Batch Upload** and **Green/Red Validation**.
```
### Visualization
...
**Project Repository:**  
https://github.com/YoHa2024NKU/Tigrinya_TrOCR_Printed
